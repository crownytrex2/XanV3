...
Gui, Add, GroupBox, x290 y50 w200 h145, Options
...
Gui, Add, CheckBox, x300 y170 vbaitdelay, Bait Delay
Gui, Tab, Credits
...
Gui Add, Edit,x4 y60 w140 h25 vsrightd cBlack, 1.4

Gui Add, Text, x4 y100 w140 h40,  StableRightMultiplier:
Gui Add, Edit,x4 y120 w140 h25 vsrightm cBlack, 2.122
Gui Add, Text,x350 y45 w140 h40, StableLeftDivision:
Gui Add, Edit,x350 y60 w140 h25 vsleftd cBlack, 1.26
Gui Add, Text,x350 y100 w140 h40, StableLeftMultiplier:
Gui Add, Edit,x350 y120 w140 h25 vsleftm cBlack, 2.25
Gui Add, Text,x175 y45 w140 h40, Bar Size:
Gui Add, Edit,x175 y60 w140 h25 vbarsize cBlack, 0 
...
SaveSettings:
	...
	IniWrite, %baitdelay%, Settings.ini, Settings, Bait-Delay
...
LoadSettings:
	...
	IniRead, inibaitdelay, Settings.ini, Settings, Bait-Delay
	;------------
	...
	GuiControl,, baitdelay, %inibaitdelay%
...
LoadMacro:
    ...
    UnstableRightMultiplier := 2.462
    UnstableRightDivision := 1.5250
    UnstableLeftMultiplier := 2.35
